...
public class SysRole extends BaseEntity {
    ...
    public SysRole(Long roleId, String roleName, String roleKey, String roleSort, String dataScope, boolean menuCheckStrictly, boolean deptCheckStrictly, String status, String delFlag, boolean flag, Long[] menuIds, Long[] deptIds) {
        this.roleId = roleId;
